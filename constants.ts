...
export const PERSONAL_INFO = {
  ...
  summary: "I am a dedicated Software Developer currently working full-time at Guru Solutions, focusing on building robust .NET applications. I am also actively rebuilding StoreYako, a cloud-based inventory management system, leveraging the performance of Rust for the backend and TypeScript for a responsive, modern frontend. Beyond my professional work, I am a passionate hobbyist who enjoys creating and working on various personal projects in my free time."
};
