...
export const PERSONAL_INFO = {
  ...
  summary: "I am a dedicated Software Developer currently working full-time at Guru Solutions, focusing on building robust .NET applications. I am also the creator of StoreYako.com, which is currently in beta testing in my local town (www.storeyako.com). Rebuilt with a focus on performance and reliability, the platform leverages Rust for the backend and TypeScript for the frontend. As a passionate hobbyist, I spend my free time creating and working on personal projects to continuously sharpen my technical skills."
};
