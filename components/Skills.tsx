    ...
    <Section id="skills" title="Technical Arsenal" className="bg-dark">
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
        {SKILLS.map((skill) => (
          <div 
            key={skill.name}
            className="group flex items-center p-3 bg-card border border-slate-800 rounded-lg hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 break-inside-avoid hover:scale-105"
          >
