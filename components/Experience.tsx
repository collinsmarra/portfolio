        ...
        <div className="md:col-span-2 space-y-8">
          ...
          <div className="relative border-l border-slate-800 ml-3 space-y-12">
            {EXPERIENCES.map((exp, index) => (
              <div key={exp.id} className="relative pl-8 md:pl-12 break-inside-avoid group transition-transform duration-300 hover:scale-[1.01]">
                <span className="absolute -left-[5px] top-2 h-2.5 w-2.5 rounded-full bg-primary ring-4 ring-slate-900 group-hover:scale-150 transition-transform"></span>
